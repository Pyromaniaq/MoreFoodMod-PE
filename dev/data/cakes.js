...
Ace3.addItem("chocolate_cookie_cake_item", "Chocolate Cookie Cake", {name:"ChocolateCookieCake",meta:0},{stack:1});
...
IDRegistry.genBlockID("chocolate_cookie_cake");
IDRegistry.genBlockID("pizza");

Ace3.addCake({
blockID:"chocolate_cake",
name:"Chocolate Cake",
texture:"chocolate",
useItem:ItemID.chocolate_cake_item,
saturation:3
});
...
name:"Nether Cake",
texture:"nether",
useItem:ItemID.nether_cake_item,
saturation:3
});
...
name:"Cheese Cake",
texture:"cheese",
useItem:ItemID.cheese_cake_item,
saturation:3
});

Ace3.addCake({
blockID:"pumpkin_cake",
name:"Pumpkin Cake",
texture:"pumpkin",
useItem:ItemID.pumpkin_cake_item,
saturation:3
});

Ace3.addCake({
blockID:"strawberry_cake",
name:"Strawberry Cake",
texture:"strawberry",
useItem:ItemID.strawberry_cake_item,
saturation:3
});

Ace3.addCake({
blockID:"chocolate_cookie_cake",
name:"Chocolate Cookie Cake",
texture:"chocolate_cookie",
useItem:ItemID.chocolate_cookie_cake_item,
saturation:3
});
